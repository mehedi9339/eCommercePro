...
namespace eCommerce.Migrations
{
    ...
    [Migration("20201005181538_initialCreate")]
            ...
            modelBuilder.Entity("eCommerce.Models.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a357def2-dc2f-4185-a388-89b3835e1f19"),
                            ConcurrencyStamp = "22a73f64-abcf-41e1-806b-86245b5ff243",
                            Name = "Super Admin",
                            NormalizedName = "SUPER ADMIN"
                        },
                        new
                        {
                            Id = new Guid("7f84c9f2-fcd6-44ef-aebf-3c7f43371a89"),
                            ConcurrencyStamp = "da65f8be-28e5-4bc0-8766-96c4541a91f7",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("03187b54-67d9-40f2-a769-7b43b45e0727"),
                            ConcurrencyStamp = "1fceac63-121c-448e-bfda-9d99f6ea9635",
                            Name = "Customer",
            ...
            modelBuilder.Entity("eCommerce.Models.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0fe28e5-590d-44ad-9356-77d592c639fe"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6a285c11-e72c-47e9-8ba8-82ed226dec44",
                            Email = "sadmin@sadmin.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "SADMIN@SADMIN.COM",
                            PasswordHash = "ALCvcuElJgpcrfVUYJNu1cr+m+ba8S/6At9spOM2XfIHvz0m8FsSBWm3aBKENzjjfA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false
                        },
                        new
                        {
                            Id = new Guid("d5b0ddfe-2053-43eb-9845-f4df72085afd"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "21b66be4-1fc1-4d8c-8817-a70272cb7b7f",
                            Email = "admin@admin.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            PasswordHash = "APntHb9M3bKFU74gDYqYa/yqIN3Ml7HLft0I/qc6NwxOdzBQKY0xfrZ4BGCCQUfMOA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false
                        },
                        new
                        {
                            Id = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "408dbdcf-24cc-485e-9449-9aad24f333be",
                            Email = "user@user.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER@USER.COM",
                            PasswordHash = "AO0TCrXbM0s83xUzVg5f/WUrvgmZzXDDmEBj7mD/TmP+L06bo2FVS7nVKLuzKPUF5w==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Maham",
                            ThanaId = 1,
                            UserId = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd")
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DeliveryDate = new DateTime(2020, 10, 13, 0, 15, 36, 447, DateTimeKind.Local).AddTicks(8886),
                            DeliveryFee = 50m,
                            DeliveryStatus = 0,
                            OrderDate = new DateTime(2020, 10, 6, 0, 15, 36, 446, DateTimeKind.Local).AddTicks(875),
                            OrderNo = "ORD202010031",
                            OrderStatus = 1,
                            PaymentStatus = true,
                            ShippingAddressId = 1,
                            ShippingDate = new DateTime(2020, 10, 7, 0, 15, 36, 447, DateTimeKind.Local).AddTicks(9641),
                            TotalAmount = 500m,
                            TransactionId = "TRX1234567",
                            TransactionTime = new DateTime(2020, 10, 6, 0, 15, 36, 448, DateTimeKind.Local).AddTicks(2106)
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Models.PurchaseDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "dfas",
                            DiscountRate = 5m,
                            EntryBy = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd"),
                            EntryDate = new DateTime(2020, 10, 6, 0, 15, 36, 453, DateTimeKind.Local).AddTicks(8633),
                        ...
                        new
                        {
                            ...
                            DiscountRate = 5m,
                            EntryBy = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd"),
                            EntryDate = new DateTime(2020, 10, 6, 0, 15, 36, 454, DateTimeKind.Local).AddTicks(4503),
                        ...
                        new
                        {
                            ...
                            DiscountRate = 5m,
                            EntryBy = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd"),
                            EntryDate = new DateTime(2020, 10, 6, 0, 15, 36, 454, DateTimeKind.Local).AddTicks(4645),
                            ExpiryDate = new DateTime(2021, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MasterId = 1,
                            ModelId = 1,
                            NetAmount = 565m,
            ...
            modelBuilder.Entity("eCommerce.Models.SalesMaster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Note = "success",
                            OrderId = 1,
                            SalesDate = new DateTime(2020, 10, 6, 0, 15, 36, 451, DateTimeKind.Local).AddTicks(1815),
                            TotalAmount = 550m,
                            TotalPrice = 1000m,
                            TotalQuantity = 2,
                            VoucherNo = "abc"
            ...
            modelBuilder.Entity("eCommerce.Models.Stock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StockId = 1,
                            ColorId = 1,
                            ExpiryDate = new DateTime(2022, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(6868),
                            InQuantity = 100,
                            InStockQuantity = 131,
                            LotNo = 1,
                            ModelId = 1,
                            ...
                            ProductCode = "P01",
                            SizeId = 1,
                            StockDate = new DateTime(2020, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(1121),
                            StockPrice = 300m
                        },
                        new
                        {
                            StockId = 2,
                            ColorId = 2,
                            ExpiryDate = new DateTime(2022, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(8941),
                            InQuantity = 100,
                            InStockQuantity = 131,
                            LotNo = 1,
                            ModelId = 2,
                            ...
                            ProductCode = "P02",
                            SizeId = 1,
                            StockDate = new DateTime(2020, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(8840),
                            StockPrice = 300m
                        },
                        new
                        {
                            StockId = 3,
                            ColorId = 2,
                            ExpiryDate = new DateTime(2022, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(8978),
                            InQuantity = 100,
                            InStockQuantity = 131,
                            LotNo = 1,
                            ModelId = 1,
                            ...
                            ProductCode = "P03",
                            SizeId = 2,
                            StockDate = new DateTime(2020, 10, 6, 0, 15, 36, 455, DateTimeKind.Local).AddTicks(8974),
                            StockPrice = 300m
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Models.Auth.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("b0fe28e5-590d-44ad-9356-77d592c639fe"),
                            RoleId = new Guid("a357def2-dc2f-4185-a388-89b3835e1f19")
                        },
                        new
                        {
                            UserId = new Guid("76a41029-50fa-4b0e-8293-4411a79552bd"),
                            RoleId = new Guid("03187b54-67d9-40f2-a769-7b43b45e0727")
                        });
                });
